...
매년 임대료, 재산세, 보험료, 급여 등 A만원의 고정 비용이 들며, 한 대의
노트북을 생산하는 데에는 재료비와 인건비 등 총 B만원의 가변 비용이 든다고 한다.
...
입력
째 줄에 A, B, C가 빈 칸을 사이에 두고 순서대로 주어진다.
...
# num1, num2, num3 = map(int, input("고정비용, 가변비용 판매비용을 입력하세요 : ").split())
# if num3 <= num2: print(-1)
# else:
